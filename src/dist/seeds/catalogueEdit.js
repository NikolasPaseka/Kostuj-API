...
var editCatalogues = function () { return __awaiter(void 0, void 0, void 0, function () {
    var res;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, catalogue_1.Catalogue.updateMany({}, { "published": true }).exec()];
            case 1:
                res = _a.sent();
                console.log(res);
                return [2 /*return*/];
